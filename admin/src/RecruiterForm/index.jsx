        ...
        <>
            ...
            <div className="outer-container">
                ...
                <form className='rectruiter-form' onSubmit={updateProfile}>
                    ...
                    <input type="text" placeholder="Enter Recruiter Email" className="input-find-jobs" onChange={(event)=>{setformrecruiterdata({...formrecruiterData,recruiterEmail:event.target.value})}} value={formrecruiterData.recruiterEmail}/><br/>
                    <label className="label-find-jobs">Recruiter Phone</label><br/>
                    <input type="text" placeholder="Enter Recruiter Phone" className="input-find-jobs" onChange={(event)=>{setformrecruiterdata({...formrecruiterData,recruiterPhone:event.target.value})}} value={formrecruiterData.recruiterPhone}/><br/>
                    ...
                    <input type="text" placeholder="Enter company website url" className="input-find-jobs" onChange={(event)=>{setformrecruiterdata({...formrecruiterData,companyWebsiteUrl:event.target.value})}} value={formrecruiterData.companyWebsiteUrl}/><br/>
                    <label className="label-find-jobs">Company Logo Url</label><br/>
                    <input type="text" placeholder="Enter company logo url" className="input-find-jobs" onChange={(event)=>{setformrecruiterdata({...formrecruiterData,companyLogoUrl:event.target.value})}} value={formrecruiterData.companyLogoUrl}/><br/>
                    <label className="label-find-jobs">Company Reviews</label><br/>
                    <input type="text" placeholder="Enter company Reviews" className="input-find-jobs" onChange={(event)=>{setformrecruiterdata({...formrecruiterData,companyReviews:event.target.value})}} value={formrecruiterData.companyReviews}/><br/>
                    <label className="label-find-jobs">Company Number</label><br/>
                    <input tye="text" placeholder="Enter company Number" className="input-find-jobs" onChange={(event)=>{setformrecruiterdata({...formrecruiterData,companyNumber:event.target.value})}} value={formrecruiterData.companyNumber}/><br/>
                    ...
                    <input type="text" placeholder="Enter company linked in profile url" className="input-find-jobs" onChange={(event)=>{setformrecruiterdata({...formrecruiterData,companyLinkedinUrl:event.target.value})}} value={formrecruiterData.companyLinkedinUrl}/><br/>
                    <label className="label-find-jobs">Company Coorporate Email</label><br/>
                    <input type="text" placeholder="Enter company coorporate email address" className="input-find-jobs" onChange={(event)=>{setformrecruiterdata({...formrecruiterData,companycoorparateEmail:event.target.value})}} value={formrecruiterData.companycoorparateEmail}/><br/>
